...
public class FieldDetectorStrength extends Detector
{

    public static final String TYPE = "fielddetectorstrength";
...
//------------------------------------------------------------------------------
    ...
    protected void updateIndicator( double x, double y )
    {
        ...
        field = Math.sqrt( ex * ex + ey * ey );

        setIndicatorValue( field );

        String svalue = Double.toString( field *
        getProperties().fieldDetectorStrengthScale.getValue() );
