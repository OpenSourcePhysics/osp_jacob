...
public class CondIntegrator extends ModIntegrator
{
...
//------------------------------------------------------------------------------
    ...
    protected void particlePostIntegrate( Particle p )
    {
        if ( !p.isFixed() )
        {
            ...
            loc.x += (mx + ex) * integrationStep;
            loc.y += (my + ey) * integrationStep;

// next two lines were commented
