...
public class DipoleKillIntegrator extends ModIntegrator
{
...
//------------------------------------------------------------------------------
    ...
    protected void particlePostIntegrate( Particle p )
    {
        if ( !p.isFixed() )
        {
            ...
            loc.x += (vx + (mx/2 + ex/2) * integrationStep) * integrationStep;
            loc.y += (vy + (my/2 + ey/2) * integrationStep) * integrationStep;
