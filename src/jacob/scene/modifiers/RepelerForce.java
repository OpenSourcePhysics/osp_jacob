...
public class RepelerForce extends VectorModifier
    implements EFModifier
{

    public static final String TYPE = "repelerforce";
...
//------------------------------------------------------------------------------
    ...
    public void preIntegrationModify( long time )
    {
        ...
        double s = getProperties().repelerforceConst.getValue();
...
//------------------------------------------------------------------------------
    ...
    public void paintFg( SceneGraphics g )
    {
        ...
        g.setColor( getProperties().repelerforceFg.getValue() );
