...
public class OscForce extends VectorModifier
    implements EFModifier
{
    public static final String TYPE = "oscforce";
...
//------------------------------------------------------------------------------
 ...
 //           tp = time / getProperties().oscforcePeriod.getValue();
        tp = time / getProperties().oscchargePeriod.getValue(); //vv 21.9.2002 To be FIXED
